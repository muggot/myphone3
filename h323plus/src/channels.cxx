  ...
  void H323_RTPChannel::Transmit()
{
  ...
  if (rtpPayloadType == RTP_DataFrame::G722) framesInPacket/=10; // codec works with 10ms frames, but in h245 capability assigned frame time in ms
...
//       PThread::Sleep(2);
    ...
    else PTRACE(3, "H323READ\t Drop Packet isAudio=" << isAudio << " sendPacket=" << sendPacket << " silent=" << silent << " Size=" << frame.GetPayloadSize());
