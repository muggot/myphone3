...
PSpeexAec::PSpeexAec(int _clock, int _sampletime)
...
void PSpeexAec::Receive(BYTE * buffer, unsigned & length)
{
 // PWaitAndSignal m(readwritemute);
...
void PSpeexAec::Send(BYTE * buffer, unsigned & length)
{
 // PWaitAndSignal m(readwritemute);
